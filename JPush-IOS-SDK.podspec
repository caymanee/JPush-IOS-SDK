...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/caymanee/JPush-IOS-SDK-spec"
  s.license      = {
    :type => 'Copyright',
    :text => <<-LICENSE
  ...
  s.source       = { :git => "https://github.com/caymanee/JPush-IOS-SDK-spec.git", :tag => "1.3.1" }
  s.platform     = :ios
  s.source_files = 'JPush/*'
  s.preserve_paths = "JPush/lib/*.a"
  s.frameworks = 'CFNetwork', 'CoreFoundation', 'CoreTelephony', 'SystemConfiguration', 'CoreGraphics', 'Foundation', 'UIKit'
  s.libraries   = 'JPushSDK'
  s.requires_arc = true
  s.xcconfig = { 'OTHER_LDFLAGS' => '-ObjC -all_load', 'LIBRARY_SEARCH_PATHS' => '"$(PODS_ROOT)/JPushSDK/JPush"' }
end
